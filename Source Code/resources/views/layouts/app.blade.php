        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link {{ Request::path() == 'admin/orders' ? 'active' : ''}}"  href="{{asset('/admin/orders')}}"><i class="fas fa-fw fa-file mb-2"></i>Manage Orders
                </a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item ">
                <a class="nav-link {{ Request::path() == 'admin/contacts' ? 'active' : ''}}"  href="{{asset('/admin/contacts')}}"><i class="fas fa-file-alt"></i>Manage Contacts
                </a>
              </li>
