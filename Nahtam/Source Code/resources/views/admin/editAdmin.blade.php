      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            <form action="{{ route('admin.admin.update', $admin->id) }}" class="col-sm-12" method="post" enctype="multipart/form-data">
              @method('PATCH')
              {{ csrf_field() }}
              ...
              <div class="form-group d-flex">
                <input name="password" id="myInput" type="password" value="{{ $admin-> password }}" class="form-control">
              ...
              <div>
                <button id="payment-button" type="submit" class="btn btn-lg btn-block myColor" name="submit">Update
                </button>
              </div>
            </form>
          </div>
